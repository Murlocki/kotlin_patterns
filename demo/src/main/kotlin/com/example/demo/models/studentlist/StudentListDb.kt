...
import com.example.demo.models.studentlist.StudentListAdapter
import java.util.*
...
class StudentListDB(): StudentListAdapter {
    ...
    override fun getKNStudentShortList(k: Int, n: Int): MutableList<StudentShort> {
        return orderedStudentList.slice((k-1) * n..<min((k-1) * n + n, orderedStudentList.size)).map { StudentShort(it) }.toMutableList();
    }
